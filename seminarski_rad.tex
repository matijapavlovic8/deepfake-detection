...
\begin{figure}[H]
   ...
   \subfigure[\textit{True positives}]{\includegraphics[width=0.8\linewidth]{slike/tp.png}}
   \subfigure[\textit{False positives}]{\includegraphics[width=0.8\linewidth]{slike/fp.png}}
   \subfigure[\textit{True negatives}]{\includegraphics[width=0.8\linewidth]{slike/tn.png}}
   \subfigure[\textit{False negatives}]{\includegraphics[width=0.8\linewidth]{slike/fn.png}}
